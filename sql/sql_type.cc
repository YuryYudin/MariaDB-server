                                                          ...
                                                          Native *to) const
{
  ...
  uint dec= item->time_precision(thd);
  return Time(thd, item, Time::Options(thd), dec).to_native(to, dec);
}
                                                                 ...
                                                                 const
{
  ...
  int warn;
  uint dec= item->time_precision(thd);
  return Time(&warn, &ltime, 0, Time::Options(thd), dec).to_native(to, dec);
}
